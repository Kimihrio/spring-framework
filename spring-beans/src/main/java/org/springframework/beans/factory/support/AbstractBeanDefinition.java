...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * 用来标识一个 bean 的实例化依靠另一个 bean 线先实例化，对应 bean 属性的 depend-on
	 */
	@Nullable
	private String[] dependsOn;

	/**
	 * autowireCandidate 属性设置为 false，这样容器在查找自动装配对象时，
	...
	/**
	 * 是否是用户自定义的而不是应用程序本身自定义的，创建 AOP 的时候为 true
	 * 程序设置
	 */
